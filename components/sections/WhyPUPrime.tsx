...
// Alternating gold/emerald only — the brief's colour system names exactly
// two accents (Luxury Gold, Modern Emerald); violet/indigo aren't in it.
const features = [
    ...
    <section id="why-pu-prime" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-5 text-stone-400 max-w-2xl mx-auto text-sm leading-relaxed">
        ...
        >
          <h3 className="text-sm font-semibold text-stone-100 mb-2">Markets, Execution &amp; Analysis Tools</h3>
        ...
        >
          <p className="text-xs text-stone-400 mb-5 max-w-lg mx-auto">
